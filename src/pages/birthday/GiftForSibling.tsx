...
const GiftForSibling = () => {
  const { data: products = [] } = useSubcategoryProducts("Birthday", "Gift for Sibling");
    ...
    <div className="min-h-screen bg-gradient-soft">
      ...
      <section className="relative h-80 overflow-hidden bg-gradient-to-br from-sunshine-yellow/30 to-rose-pink/30">
        ...
        <div className="relative flex h-full items-center justify-center text-center">
          <div className="max-w-3xl px-4">
            <h1 className="mb-4 text-5xl font-bold">Birthday Gifts for Siblings</h1>
            <p className="text-lg text-muted-foreground">
              Special gifts for your brother or sister
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="flex items-center justify-between mb-6">
          ...
          />
          <AdminAddProductButton defaultCategory="Birthday" defaultSubcategory="Gift for Sibling" />
        </div>
