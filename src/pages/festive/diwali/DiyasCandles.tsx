  ...
  return (
    <div className="min-h-screen bg-gradient-soft">
      ...
      <section className="relative h-80 overflow-hidden bg-gradient-to-br from-amber-500/30 to-orange-600/30">
        <div className="absolute inset-0 bg-[url('/images/diyas.png')] bg-cover bg-center"  />
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="flex items-center justify-between mb-6">
          ...
          />
          <AdminAddProductButton defaultCategory="Festive" defaultSubcategory="Diyas and Candles" />
        </div>
