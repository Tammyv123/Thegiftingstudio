...
const WeddingHampers = () => {
  const { data: products = [], refetch } = useSubcategoryProducts("Wedding", "Hampers");
      ...
      <section className="relative h-80 overflow-hidden bg-gradient-to-br from-rose-pink/30 to-lavender/30">
        ...
        <div className="relative flex h-full items-center justify-center text-center">
          <div className="max-w-3xl px-4">
            <h1 className="mb-4 text-5xl font-bold">Wedding Hampers</h1>
            <p className="text-lg text-muted-foreground">
              Luxurious hampers for wedding celebrations
            </p>
          </div>
        </div>
      </section>
