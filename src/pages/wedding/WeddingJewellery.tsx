...
const WeddingJewellery = () => {
  const { data: products = [] } = useSubcategoryProducts("wedding gift", "jewellery");
      ...
      <section className="relative h-80 overflow-hidden bg-gradient-to-br from-rose-pink/30 to-lavender/30">
        ...
        <div className="relative flex h-full items-center justify-center text-center">
          <div className="max-w-3xl px-4">
            <h1 className="mb-4 text-5xl font-bold">Wedding Jewellery</h1>
            <p className="text-lg text-muted-foreground">
              Stunning jewellery for brides and guests
            </p>
          </div>
        </div>
      </section>
