...
const WeddingProps = () => {
  const { data: products = [] } = useSubcategoryProducts("Wedding", "Props");
      ...
      <section className="relative h-80 overflow-hidden bg-gradient-to-br from-rose-pink/30 to-lavender/30">
        ...
        <div className="relative flex h-full items-center justify-center text-center">
          <div className="max-w-3xl px-4">
            <h1 className="mb-4 text-5xl font-bold">Wedding Props</h1>
            <p className="text-lg text-muted-foreground">
              Creative props for unforgettable wedding moments
            </p>
          </div>
        </div>
      </section>
