...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are a helpful shopping assistant for "The Gifting Studio", an online gift store. 
    
Our product categories include:
- Festive Gifts (Diwali hampers, Holi color sets, Christmas decorations)
- Birthday Gifts (surprise boxes, cakes with flowers)
